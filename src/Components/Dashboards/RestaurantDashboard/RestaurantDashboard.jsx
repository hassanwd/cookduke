        ...
        <div className='upper'>
            <div className="social">
                ...
                <div className="social_buttons">
                    <button> <AiFillVideoCamera className='social_icons'/>{t("video")}</button>
                    <button><FaImage className='social_icons'/>{t("photo")}</button>
                    <button><AiFillYoutube className='social_icons'/>{t("youtube_link")}</button>
                </div>
            </div>
